    ...
    internal class SecurityMetadata
    {
        ...
        private void ParseSecuritySource(Func<object> securitySource)
        {
            ...
            foreach (var prop in security.GetType().GetProperties())
            {
                ...
                var secMetadata = prop.GetCustomAttribute<ApiMetadata>()?.GetSecurityMetadata();
                if (secMetadata == null)
                {
                    continue;
                }
        ...
        private void ParseScheme(ApiMetadata.SecurityMetadata schemeMetadata, object scheme)
        {
        ...
        private void ParseSchemeValue(
            ApiMetadata.SecurityMetadata schemeMetadata,
            ApiMetadata.SecurityMetadata valueMetadata,
            object value
        )
        {
