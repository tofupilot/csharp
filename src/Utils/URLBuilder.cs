    ...
    internal static class URLBuilder
    {
        ...
        private static Dictionary<string, string> GetPathParameters(object? request)
        {
            ...
            foreach (var prop in props)
            {
                ...
                if (prop.GetCustomAttribute<ApiMetadata>()?.GetRequestMetadata() != null)
                {
                    continue;
                }

                var metadata = prop.GetCustomAttribute<ApiMetadata>()?.GetPathParamMetadata();
        ...
        private static Dictionary<string, List<string>> TrySerializeQueryParams(object? request)
        {
            ...
            foreach (var prop in props)
            {
                ...
                var metadata = prop.GetCustomAttribute<ApiMetadata>()?.GetQueryParamMetadata();
                if (metadata == null)
                {
                    continue;
                }
