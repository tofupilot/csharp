    ...
    public class Units: IUnits
    {
        ...
        public async Task<UnitListResponse> ListAsync(string? searchQuery = null, List<string>? ids = null, List<string>? serialNumbers = null, List<string>? partNumbers = null, List<string>? revisionNumbers = null, List<string>? batchNumbers = null, List<string>? procedureIds = null, List<UnitListQueryParamOutcome>? outcomes = null, DateTime? startedAfter = null, DateTime? startedBefore = null, bool? latestOnly = false, long? runCountMin = null, long? runCountMax = null, DateTime? createdAfter = null, DateTime? createdBefore = null, List<string>? createdByUserIds = null, List<string>? createdByStationIds = null, bool? excludeUnitsWithParent = false, List<UnitListQueryParamSample>? samples = null, long? limit = 50, long? cursor = null, UnitListSortBy? sortBy = global::TofuPilot.Models.Requests.UnitListSortBy.CreatedAt, UnitListSortOrder? sortOrder = global::TofuPilot.Models.Requests.UnitListSortOrder.Desc, Dictionary<string, object>? metadata = null, bool? includeMetadata = false, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (_statusCode == 401 || _statusCode == 408 || _statusCode >= 400 && _statusCode < 500 || _statusCode == 500 || _statusCode >= 500 && _statusCode < 600)
                {
                    var _httpResponse = await this.SDKConfiguration.Hooks.AfterErrorAsync(new AfterErrorContext(hookCtx), httpResponse, null);
                    if (_httpResponse != null)
                    {
            ...
            else if(responseStatusCode == 408)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<RequestTimeoutException>(await httpResponse.Content.ReadAsStringAsync(cancellationToken), includeNulls: true);
                    throw obj!;
                }
        ...
        public async Task<UnitGetResponse> GetAsync(string serialNumber, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (_statusCode == 400 || _statusCode == 401 || _statusCode == 404 || _statusCode == 408 || _statusCode >= 400 && _statusCode < 500 || _statusCode == 500 || _statusCode >= 500 && _statusCode < 600)
                {
                    var _httpResponse = await this.SDKConfiguration.Hooks.AfterErrorAsync(new AfterErrorContext(hookCtx), httpResponse, null);
                    if (_httpResponse != null)
                    {
            ...
            else if(responseStatusCode == 408)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<RequestTimeoutException>(await httpResponse.Content.ReadAsStringAsync(cancellationToken), includeNulls: false);
                    throw obj!;
                }
