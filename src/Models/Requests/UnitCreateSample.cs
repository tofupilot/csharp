...
namespace TofuPilot.Models.Requests
{
    ...
    public static class UnitCreateSampleExtension
    {
        public static string Value(this UnitCreateSample value)
        {
        ...
        public static UnitCreateSample ToEnum(this string value)
        {
            foreach(var field in typeof(UnitCreateSample).GetFields())
            {
                ...
                if (attribute != null && attribute.Name == value)
                {
                    ...
                    if (enumVal is UnitCreateSample)
                    {
                        return (UnitCreateSample)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum UnitCreateSample");
        }
    }
