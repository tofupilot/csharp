...
namespace TofuPilot.Models.Requests
{
    ...
    public enum DeploymentGetProvider
    {
    ...
    {
        public static string Value(this DeploymentGetProvider value)
        {
        ...
        public static DeploymentGetProvider ToEnum(this string value)
        {
            foreach(var field in typeof(DeploymentGetProvider).GetFields())
            {
                ...
                if (attribute != null && attribute.Name == value)
                {
                    ...
                    if (enumVal is DeploymentGetProvider)
                    {
                        return (DeploymentGetProvider)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum DeploymentGetProvider");
        }
    }
