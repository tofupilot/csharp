...
namespace TofuPilot.Models.Requests
{
    ...
    public static class RunListUnitSampleExtension
    {
        public static string Value(this RunListUnitSample value)
        {
        ...
        public static RunListUnitSample ToEnum(this string value)
        {
            foreach(var field in typeof(RunListUnitSample).GetFields())
            {
                ...
                if (attribute != null && attribute.Name == value)
                {
                    ...
                    if (enumVal is RunListUnitSample)
                    {
                        return (RunListUnitSample)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum RunListUnitSample");
        }
    }
